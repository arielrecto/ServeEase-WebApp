        ...
        <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex items-center justify-between w-full">
                        <div class="flex items-center shrink-0">
                            ...
                            >
                                ...
                                <NavLink
                                    :href="route('guest.about-us')"
                                    :active="route().current('guest.about-us')"
                                >
                                    About Us
                                </NavLink>
                                <NavLink
                                    :href="route('guest.terms-and-condition')"
                                    :active="
                                        route().current(
                                            'guest.terms-and-condition'
                                        )
                                    "
                                >
                        ...
                        <div
                            v-if="canLogin"
                            class="hidden md:flex md:items-center gap-x-2 md:gap-x-8"
                        >
                            <!-- <Link
            ...
            >
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <ResponsiveNavLink
                        :href="route('guest.terms-and-condition')"
                        :active="route().current('guest.terms-and-condition')"
                    >
                        Terms and Conditions
                    </ResponsiveNavLink>
