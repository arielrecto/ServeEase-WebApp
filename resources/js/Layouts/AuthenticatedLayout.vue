...
<template>
    <!-- Flash messages -->
    <FlashMessage v-if="$page.props.flash.message_success" type="success" :message="$page.props.flash.message_success" />
    <FlashMessage v-if="$page.props.flash.message_error" type="error" :message="$page.props.flash.message_error" />
    <FlashMessage v-if="$page.props.flash.message_warning" type="warning" :message="$page.props.flash.message_warning" />

    <div>
        <div class="min-h-screen bg-gray-100">
            <nav class="sticky top-0 left-0 z-20 bg-white border-b border-gray-100">
