...
<template>
    <Modal ref="modalRef">
        <h2 class="text-2xl font-semibold">{{ providerProfile.profile.first_name + ' ' + providerProfile.profile.last_name }}</h2>
        ...
        <section class="space-y-4 overflow-y-hidden">
            ...
            <div class="flex flex-col gap-y-3">
                <div class="flex flex-col gap-y-1">
                    ...
                    <span class="text-gray-600">{{ providerProfile.service_type }}</span>
                </div>
                <div class="flex flex-col gap-y-1">
                    <span class="font-semibold">Years of experience</span>
                    <span class="text-gray-600">{{ providerProfile.experience }}</span>
                </div>
                <div class="flex flex-col gap-y-1">
                    <span class="font-semibold">Contact Number</span>
                    <span class="text-gray-600">{{ providerProfile.contact }}</span>
                </div>
                <div class="flex flex-col gap-y-1">
                    <span class="font-semibold">Certificate</span>
                    <div class="w-full">
                        <img :src="providerProfile.certificate" alt="Provider certificate" class="object-cover">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section>
            <button class="flex items-center w-full panel-btn panel-btn-accept" onclick="my_modal_2.showModal()">Approve</button>
            <dialog id="my_modal_2" class="modal">
                <div class="modal-box">
                    ...
                    <div class="space-y-6">
                        <h2 class="text-xl font-semibold leading-tight text-gray-800">Approve this application?</h2>
                        <p>Approving this user means they are an official service provider for ServEase.</p>
