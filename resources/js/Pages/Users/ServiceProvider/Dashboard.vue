...
import { Chart as ChartJS, Title, Tooltip, Legend, BarElement, CategoryScale, LinearScale, ArcElement, PieController, BarController } from 'chart.js';
            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 gap-8 mb-8 lg:grid-cols-2">
                    <div class="p-6 bg-white rounded-lg shadow">
                        <h3 class="mb-4 text-lg font-semibold">Revenue Overview</h3>
                        <div class="h-80">
                            <canvas id="revenueChart"></canvas>
                        </div>
                    </div>
                    <div class="p-6 bg-white rounded-lg shadow">
                        <h3 class="mb-4 text-lg font-semibold">Booking Status Distribution</h3>
                        <div class="h-80">
                        ...
                        <table class="w-full">
                            ...
                            <tbody>
                                ...
                                <tr v-for="booking in recentBookings" :key="booking.id" class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="p-3">{{ moment(booking.created_at).format('MMM D, YYYY') }}</td>
                                    <td class="p-3">
                                        <span :class="{
                                    ...
                                    <td class="p-3 font-medium">${{ booking.total_price.toFixed(2) }}</td>
                                </tr>
