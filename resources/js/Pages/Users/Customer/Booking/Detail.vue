                                ...
                                <TabPanel value="1">
                                    <div class="space-y-6">
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div
                                                v-if="
                                                    availService.transactions
                                                        ?.length
                                                "
                                                class="divide-y divide-gray-200"
                                            >
                                                <div
                                                    v-for="transaction in availService.transactions"
                                                    :key="transaction.id"
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <i
                                                                    class="text-gray-500 fa-solid fa-file-image"
                                                                ></i>
                                                                {{
                                            ...
                                            >
                                                <i
                                                    class="mb-3 text-4xl text-gray-400 fa-solid fa-receipt"
                                                ></i>
                                                <h4
                                                ...
                                                >
                                                    <i
                                                        class="mr-2 fa-solid fa-credit-card"
                                                    ></i>
                                                    Make Payment
                                                </Link>
                                            </div>
